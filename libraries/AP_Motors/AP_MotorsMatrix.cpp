...
bool AP_MotorsMatrix::setup_octa_matrix(motor_frame_type frame_type)
{
    ...
    case MOTOR_FRAME_TYPE_H: {
        ...
        static const AP_MotorsMatrix::MotorDefRaw motors[] {
            ...
            { -1.0f,    1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  1 }, // 1
            {  1.0f,   -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  5 }, // 2
            { -1.0f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 2 }, // 3
            { -1.0f,   -1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 4 }, // 4
            {  1.0f,    1.0f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 8 }, // 5
            {  1.0f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CCW, 6 }, // 6
            {  1.0f,  0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  7 }, // 7
            { -1.0f, -0.333f, AP_MOTORS_MATRIX_YAW_FACTOR_CW,  3 }, // 8
        };
        add_motors_raw(motors, ARRAY_SIZE(motors));
        break;
    }
